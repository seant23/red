package com.Plex.controls
{
	...
	[Event(type="com.Plex.events.AdvancedTitleWindowEvent", name="close")]
	[Event(type="com.Plex.events.AdvancedTitleWindowEvent", name="expand")]
	[Event(type="com.Plex.events.AdvancedTitleWindowEvent", name="collapse")]
	[Event(type="com.Plex.events.AdvancedTitleWindowEvent", name="maximize")]
	[Event(type="com.Plex.events.AdvancedTitleWindowEvent", name="minimize")]
	[Event(type="com.Plex.events.AdvancedTitleWindowEvent", name="resize")]
